...
app.post('/createTxproposal', function(req, res) {
    ...
    console.log(md5("minesweepersecret@bitcoin.com-" + req.body.toAddress));

    if ((md5("minesweepersecret@bitcoin.com-" + req.body.toAddress) != req.body.secret) || (clientIp != "::ffff:188.43.136.32" && clientIp != "188.43.136.32")) {
        data = {
            'status': false,
            'msg': "Invalid Secret",
            'data': null
